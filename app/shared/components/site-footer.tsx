    ...
    <footer id='contact' className='bg-card text-foreground'>
      <div className='mx-auto grid w-full max-w-6xl gap-8 px-4 py-16 md:grid-cols-4 md:px-6'>
        ...
        <div className='flex flex-col gap-3'>
          <h3 className='text-sm font-bold text-primary'>{t('footer.aboutTitle')}</h3>
        ...
        <div className='flex flex-col gap-3'>
          <h3 className='text-sm font-bold text-primary'>{t('footer.policyTitle')}</h3>
          <a className='text-sm text-muted-foreground hover:text-primary' href='#'>
        ...
        <div className='flex flex-col gap-3'>
          <h3 className='text-sm font-bold text-primary'>{t('footer.contactTitle')}</h3>
          ...
          <a className='flex items-center gap-2 text-sm font-semibold text-brand-zalo hover:underline' href='#'>
