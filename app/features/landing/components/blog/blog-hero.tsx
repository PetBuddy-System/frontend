...
export function BlogHero() {
  ...
  return (
    <section className='relative flex min-h-[420px] items-center justify-center overflow-hidden bg-muted md:min-h-[600px]'>
      ...
      <div className='relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center gap-4 px-4 py-16 text-center md:px-6'>
        ...
        <p className='max-w-xl text-base text-white/80 md:text-lg'>{t('hero.subtitle')}</p>
      </div>
    </section>
  )
}
