                                    ...
                                    <label className='flex flex-1 items-center gap-4 cursor-pointer select-none'>
                                        ...
                                        <div className='min-w-0 flex-1'>
                                            ...
                                            <p className='mt-1 text-xs text-muted-foreground'>
                                                ...
                                                Đơn giá: <span className='font-semibold text-primary'>{item.price}</span>
                                            </p>
                                        </div>
                                    </label>
                                        ...
                                        <div className='flex items-center gap-3 self-end rounded-lg border border-border bg-card p-1 shadow-sm sm:self-center'>
                                            ...
                                            <div className='flex items-center gap-1'>
                                                <button
                                                    type='button'
                                                    onClick={() =>
                                                        onQuantityChange(item.id, Math.max(1, currentQty - 1))
                                                    }
                                                ...
                                                <button
                                                    type='button'
                                                    onClick={() =>
                                                        onQuantityChange(item.id, Math.min(item.quantity, currentQty + 1))
                                                    }
