    ...
    <div className="overflow-hidden rounded-2xl bg-card shadow-sm">
      ...
      <div className="bg-primary p-6">
        <h3 className="font-display text-lg font-semibold text-primary-foreground">
          {t("orderTracking.info.title")}
        </h3>
        <p className="mt-1 text-sm font-bold text-primary-foreground/80">
          {MOCK_ORDER.id}
        </p>
      </div>
        ...
        <div className="space-y-4 border-b border-border pb-6">
          <div className="flex items-start justify-between">
            <span className="text-sm text-muted-foreground">
              {t("orderTracking.info.orderDate")}
            </span>
          ...
          <div className="flex items-start justify-between">
            <span className="text-sm text-muted-foreground">
              {t("orderTracking.info.recipient")}
            </span>
            <span className="text-right font-bold text-foreground">
              {MOCK_ORDER.recipient}
            </span>
          </div>
          <div className="flex items-start justify-between">
            <span className="text-sm text-muted-foreground">
              {t("orderTracking.info.address")}
            </span>
        ...
        <div className="space-y-2 rounded-xl bg-muted p-4">
          ...
          <div className="flex justify-between">
            <span className="text-sm">
              {t("orderTracking.info.shippingFee")}
            </span>
            <span className="text-sm">
              {MOCK_ORDER.shippingFee ?? t("orderTracking.info.shippingFree")}
            </span>
          </div>
