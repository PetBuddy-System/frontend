    ...
    products: [
      {
        ...
        quantity: 1,
        price: "450.000đ",
        image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCCZjWQ89yyuLgFBsuNzQajJ9iuh41gaxosfNeE7A6CzUpEZOKRLErH53i6HwIXlrdkB1Ij4OjcKTW9OMLoHukeizoHxR2AVMpo5e9TwoPUqGk9vkTAFXZz--qy7Ubqr8OVRaTyL1VTx7AaPip9Gr57yV5p7EWr_eBukOxp4zLSpfT6rLgJnpdTNoIQDXKw5sUvSsdM1IKFKPJ_650Evt4R3fiwKZl2bPu09P47pv5QjuC6c6SnIzXk7N5JgIt-1rgn9ArnmmjO04g",
      },
      {
        id: "p2",
        ...
        quantity: 1,
        price: "120.000đ",
        image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDv3PKK0RyvIeSO5m-Drs04bT81aPST8RY3Lssnb70QwUkIAxaB8vj7CPOZvt37Gpcsj8Ry6bUlJ19PVY5hQJyz1b52A_F4xUEnOUyZFgG9GcOyXR7ZzgXA8IzqEjtvsBWHo6HFIxy5J_rPkbfNCfnShKYIoFRFDu6scFff2Jsov7hYma86mGcsrhttFUCdzTW9QqAwOtO1vJLLs9rc-K7dygqcjz5eSSZKp71_0TKbpXtDnog88drm2cWeysiY1ls_foUD2SR2muA",
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        quantity: 2,
        price: "120.000đ",
        image: "https://lh3.googleusercontent.com/aida/ADBb0uiD2iNUbQz2Hs_xHergS9X6TBN_RLOdfzCsTQyFr6mPAI-q3PGlxKrEMWRS2mZ6NW5BIkBX-Zwmjrxk3CaHaHVNRCBreBxbANzRZjr6NDa5HAh66eUX-SlKemHGRcmR_oQWLH6UM8Cx6etWFvrzC_Zx7Ik9t1KFjGCBvXF-f5CrDF0NKIcL2T-AIK1gNaPoq4OK1LWnzv-OI2BejbgO7sGLwh9HNHuYMAvDK00LoTsZwkVJulKsabSdbqs",
      },
    ],
  },
];
    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border border-border bg-card p-8 text-center shadow-md">
        ...
        <p className="mt-2 max-w-md text-sm text-muted-foreground">
          {t("returnWarranty.success.message")}
        </p>
        <button
          type="button"
          onClick={resetForm}
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          >
            ...
            <span className="text-sm font-bold">
              {t("returnWarranty.type.exchange")}
            </span>
          </label>
          ...
          >
            ...
            <span className="text-sm font-bold">
              {t("returnWarranty.type.warranty")}
            </span>
          </label>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          ...
          >
            ...
            <span className="text-[10px] font-bold uppercase">
              {t("returnWarranty.photos.upload")}
            </span>
          </button>
