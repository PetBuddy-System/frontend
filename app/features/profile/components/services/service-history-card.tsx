          ...
          <div>
              ...
              <div>
                <h2
                  className={cn(
                    ...
                    item.status === 'cancelled' ? 'text-muted-foreground' : 'text-foreground group-hover:text-primary'
                  )}
                >
            ...
            >
              {item.status === 'cancelled' ? (
                <p className='italic text-destructive'>{t(`serviceHistory.items.${item.key}.reason`)}</p>
              ) : (
                <>
                  <div className='flex items-center gap-2'>
                    <MaterialIcon
                      name='schedule'
                      className={cn('text-[22px]', item.status === 'upcoming' && 'text-primary')}
                    />
