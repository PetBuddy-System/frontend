...
export const SERVICE_HISTORY_FILTERS = ['all', 'upcoming', 'completed', 'cancelled'] as const
...
export function ServiceHistoryFilters({ activeFilter, onFilterChange }: ServiceHistoryFiltersProps) {
