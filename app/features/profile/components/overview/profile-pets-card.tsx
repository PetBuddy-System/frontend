          ...
          >
            <div className='flex items-center gap-4'>
              ...
              <div className='flex-1'>
                <h3 className='text-base font-bold text-foreground md:text-lg'>{t(`pets.items.${pet.key}.name`)}</h3>
                <p className='text-sm text-muted-foreground'>{t(`pets.items.${pet.key}.description`)}</p>
              </div>
              <MaterialIcon
                name='chevron_right'
