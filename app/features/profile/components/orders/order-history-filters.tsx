...
export const ORDER_HISTORY_FILTERS = ['all', 'pending', 'shipping', 'delivered', 'cancelled'] as const
...
export function OrderHistoryFilters({ activeFilter, onFilterChange }: OrderHistoryFiltersProps) {
