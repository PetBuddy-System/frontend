...
import { ReturnPolicyInfo } from "../components/return-policy-info";
import { ReturnSupportCard } from "../components/return-support-card";
import { ReturnWarrantyForm } from "../components/return-warranty-form";
      ...
      >
        ...
        <nav className="mb-4 flex items-center gap-1 text-xs font-semibold text-muted-foreground">
          ...
          <span className="font-bold text-primary">
            {t("returnWarranty.breadcrumb.current")}
          </span>
        </nav>

        <ProfilePageHeader
          titleKey="returnWarranty.headerTitle"
          subtitleKey="returnWarranty.headerSubtitle"
        />
