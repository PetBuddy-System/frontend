 ...
 */
export async function createOrderReviewApi(
    orderId: number,
 ...
 */
export async function getManagementReviewsApi(
    params?: {
        keyword?: string
        rating?: number
        status?: ReviewStatus
    ...
    try {
        ...
        const queryString = searchParams.toString()
        const url = queryString
            ? `/api/management/reviews?${queryString}`
            : `/api/management/reviews`

        const response = await axiosInstance.get<ApiResponse<Page<ProductReviewManagerResponse>> | Page<ProductReviewManagerResponse>>(
            url,
            {
                headers: getAuthHeaders()
            }
...
export async function updateReviewStatusApi(
    ...
    try {
        await axiosInstance.patch(
            `/api/management/reviews/${reviewId}/status`,
            data,
            {
                headers: getAuthHeaders()
            }
