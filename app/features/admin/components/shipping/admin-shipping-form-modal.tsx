    ...
    <div className='bg-card rounded-2xl w-full max-w-md p-6 border border-border shadow-xl relative animate-in fade-in zoom-in-95 duration-150'>
      <div className='flex items-center justify-between mb-6 border-b border-border/60 pb-3'>
        <div className='flex items-center gap-3'>
          ...
          <h3 className='font-bold text-lg text-primary'>{mode === 'add' ? 'Thêm quy tắc mới' : 'Cập nhật Quy tắc'}</h3>
        </div>
      ...
      >
        <div>
          <label className='block text-sm font-semibold text-muted-foreground mb-1.5'>Khoảng cách tối thiểu (km)</label>
          <input
            type='number'
            step='any'
            value={minDistance}
        ...
        <div>
          <label className='block text-sm font-semibold text-muted-foreground mb-1.5'>Khoảng cách tối đa (km)</label>
          <input
            type='number'
            step='any'
            value={maxDistance}
        ...
        <div>
          <label className='block text-sm font-semibold text-muted-foreground mb-1.5'>Phí vận chuyển (VND)</label>
