...
export function OrderSuccessConfetti() {
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      particles = particles.filter((particle) => particle.y < canvasElement.height)
  ...
  return <canvas ref={canvasRef} className='pointer-events-none fixed inset-0 z-[100] h-full w-full' aria-hidden />
}
