...
export function CheckoutDeliveryMethods({ formatPrice }: CheckoutDeliveryMethodsProps) {
  ...
  return (
    <section className='rounded-xl border border-border/60 bg-card p-6 shadow-sm md:p-8'>
      <div className='mb-6 flex items-center gap-3'>
        ...
        <h2 className='font-display text-2xl font-semibold text-primary'>{t('checkout.delivery.title')}</h2>
      </div>
          ...
          return (
            ...
            >
              ...
              <span className='flex flex-1 flex-col'>
                <span className='font-semibold text-foreground'>{t(`checkout.delivery.methods.${method}.title`)}</span>
