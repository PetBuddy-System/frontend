...
export function ProductDetailInfo() {
  ...
  return (
    <section className='flex flex-col justify-start'>
      <h1 className='text-3xl font-bold text-foreground md:text-4xl font-display'>{t('detail.product.title')}</h1>
      ...
      <div className='mt-6 text-3xl font-bold text-primary font-display'>{t('detail.product.price')}</div>

      <p className='mt-6 text-base leading-7 text-muted-foreground md:text-lg'>{t('detail.product.summary')}</p>
