  ...
  return (
    <div className='flex h-screen overflow-hidden bg-background text-foreground'>
      ...
      <div className='flex min-w-0 flex-1 flex-col overflow-hidden'>
        <StaffTopNav titleKey='shiftRequest.pageTitle' subtitleKey='shiftRequest.pageSubtitle' />
        <main className='flex-1 overflow-y-auto p-4 md:p-6'>
          <div className='mx-auto flex max-w-7xl flex-col gap-6'>
            {/* Page Header */}
            <div>
              <h1 className='font-display text-2xl font-bold lg:text-3xl'>{t('shiftRequest.heading')}</h1>
              <p className='mt-2 text-base text-muted-foreground'>{t('shiftRequest.description')}</p>
            </div>
