      ...
      <form className='space-y-6'>
        ...
        <div>
          <label className='mb-2 block text-sm font-semibold'>
            {t('shiftRequest.form.shiftLabel')} <span className='text-destructive'>*</span>
          </label>
        ...
        <div>
          <label className='mb-2 block text-sm font-semibold'>
            {t('shiftRequest.form.reasonLabel')} <span className='text-destructive'>*</span>
          </label>
          <textarea
        ...
        <div className='space-y-4 rounded-lg bg-muted p-4'>
          <label className='block text-sm font-semibold'>
            {t('shiftRequest.form.solutionLabel')} <span className='text-destructive'>*</span>
          </label>
          ...
          <div className='flex flex-col gap-3'>
            <label className='flex cursor-pointer items-center gap-3'>
              <input
                ...
                value='specific'
              />
              <span className='text-base'>{t('shiftRequest.form.solutionOptions.specific')}</span>
            </label>
            <label className='flex cursor-pointer items-center gap-3'>
              <input
                ...
                value='open'
              />
              <span className='text-base'>{t('shiftRequest.form.solutionOptions.open')}</span>
            </label>
          </div>
          ...
          {solution === 'specific' ? (
            <div className='space-y-4 border-t border-border pt-4'>
              <div>
                <label className='mb-2 block text-sm font-semibold'>{t('shiftRequest.form.colleagueLabel')}</label>
                <div className='relative'>
                  <input
              ...
              <div>
                <label className='mb-2 block text-sm font-semibold'>{t('shiftRequest.form.compensationLabel')}</label>
                <input
        ...
        <div className='flex items-center justify-end gap-4 pt-4'>
          ...
          <button
            type='submit'
            className='rounded-full bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-sm transition-all hover:shadow'
          >
