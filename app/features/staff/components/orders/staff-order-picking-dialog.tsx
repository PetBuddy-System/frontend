              ...
              {pickingItems.map((item, index) => (
                ...
                >
                  ...
                  <div className='flex-grow min-w-0'>
                    <h3 className='text-lg font-bold text-foreground leading-tight line-clamp-2'>{item.name}</h3>
                  ...
                  <div className='text-right flex flex-col items-end flex-shrink-0 ml-6'>
                    ...
                    <span className='text-3xl font-bold text-primary'>{item.quantityToPick}</span>
                  </div>
                </div>
              ))}
            </div>
