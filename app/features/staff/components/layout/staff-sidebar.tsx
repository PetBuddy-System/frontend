  ...
  return (
    <>
      <MobileSidebarDrawer>
        ...
        <nav className='min-h-0 flex-1 space-y-1 overflow-y-auto p-3'>{renderNavItems(closeMobileSidebar)}</nav>
        <div className='shrink-0 border-t border-border p-3'>{renderLogoutButton()}</div>
      </MobileSidebarDrawer>
      ...
      >
        ...
        <nav className='min-h-0 flex-1 space-y-1 overflow-y-auto p-3'>{renderNavItems()}</nav>
