  ...
  return (
    <div className='grid grid-cols-1 gap-6 sm:grid-cols-3'>
      <div className='rounded-xl border border-secondary/20 bg-secondary/5 p-6'>
        ...
        <h4 className='mb-2 font-display text-lg font-bold text-secondary'>{t('addProduct.tips.title')}</h4>
      ...
      <div className='rounded-xl border border-primary/10 bg-primary/5 p-6'>
        ...
        <h4 className='mb-2 font-display text-lg font-bold text-primary'>{t('addProduct.seo.title')}</h4>
        <p className='text-sm italic text-muted-foreground opacity-60'>{t('addProduct.seo.content')}</p>
      </div>
      ...
      <div className='rounded-xl border border-success/10 bg-success/5 p-6'>
        ...
        <h4 className='mb-2 font-display text-lg font-bold text-success'>{t('addProduct.sync.title')}</h4>
