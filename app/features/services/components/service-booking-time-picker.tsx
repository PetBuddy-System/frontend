...
export function ServiceBookingTimePicker({
  selectedTime,
  onSelectTime,
}: ServiceBookingTimePickerProps) {
          ...
          <div className="grid grid-cols-3 gap-3">
            {TIME_SLOTS.map((slot) => {
              ...
              return (
                ...
                >
                  {slot.disabled
                    ? t("bookingPage.time.fullSlot", { time: slot.key })
                    : slot.key}
                </button>
              );
            })}
