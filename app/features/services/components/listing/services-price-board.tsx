                  ...
                  <tr key={row.key} className='border-t border-border/60 align-top'>
                    <td className='px-4 py-4 md:px-5'>
                      <div className='flex items-start gap-3'>
                        <span className={`mt-0.5 inline-flex h-10 w-10 items-center justify-center rounded-xl ${row.accent}`}>
                          <MaterialIcon name={row.key === 'bath' ? 'spa' : row.key === 'grooming' ? 'content_cut' : 'cleaning_services'} className='text-[18px]' />
                        </span>
                        <div>
                    ...
                    <td className='px-4 py-4 font-semibold text-primary md:px-5'>
                      {row.prices.over20}
                    </td>
                  </tr>
                ))}
