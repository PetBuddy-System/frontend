    ...
    <section className='relative flex h-[400px] items-center overflow-hidden bg-primary md:h-[500px]'>
      ...
      <div className='relative z-10 mx-auto w-full max-w-6xl px-4 md:px-6'>
        <div className='w-full md:w-1/2'>
          <h1 className='font-display text-3xl font-bold text-primary-foreground md:text-5xl'>{t('hero.title')}</h1>
          <p className='mt-4 max-w-md text-base text-primary-foreground/80 md:text-lg'>{t('hero.subtitle')}</p>
          <button
            type='button'
