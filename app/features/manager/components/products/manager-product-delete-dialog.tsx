      ...
      <div className='relative z-10 w-full max-w-lg rounded-2xl border border-border bg-card shadow-2xl p-6 flex flex-col gap-5'>
        <div className='flex flex-col items-center gap-3 text-center'>
          ...
          <p className='text-sm text-muted-foreground'>
            Sản phẩm <span className='font-semibold text-foreground'>{productName}</span> sẽ bị chuyển sang trạng thái{' '}
            <span className='font-semibold text-destructive'>Đã xóa</span>. Bạn có thể khôi phục bằng cách chỉnh sửa
            trạng thái sau.
          </p>
        </div>
