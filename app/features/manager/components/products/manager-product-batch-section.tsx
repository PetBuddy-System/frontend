...
export function ManagerProductBatchSection({ productId, isDeleted = false }: ManagerProductBatchSectionProps) {
  ...
  return (
    <div className='bg-card rounded-2xl border border-border overflow-hidden shadow-sm'>
      ...
      <div className='p-6 flex flex-col gap-8'>
        ...
        {!isDeleted && (
          <>
            <ManagerProductBatchIntake productId={productId} onSuccess={handleBatchChange} />
