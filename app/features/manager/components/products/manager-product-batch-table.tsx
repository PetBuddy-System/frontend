              ...
              return (
                <Fragment key={batch.batchId}>
                  <tr className='hover:bg-muted/10 transition-colors'>
                    ...
                    <td className='px-4 py-3.5 font-bold text-primary font-mono text-sm'>{batch.batchCode}</td>
                    <td className='px-4 py-3.5 font-semibold text-foreground'>{batch.stockQuantity}</td>
                    ...
                    <td className='px-4 py-3.5 text-muted-foreground font-medium'>{formatDate(batch.expiryDate)}</td>
                      ...
                      <td colSpan={8} className='px-6 py-3'>
                        <div className='flex flex-wrap gap-x-8 gap-y-2 text-xs'>
                          ...
                          <div className='flex items-center gap-2 text-muted-foreground'>
                            ...
                            <span
                              className={`font-semibold ${batch.deletedAt ? 'text-destructive' : 'text-foreground'}`}
                            >
