...
type Resource = {
  href: string
  /** key trong namespace `welcome` (vd "docs", "discord") */
  key: string
  icon: ReactNode
}
...
export function WelcomeResources() {
  ...
  return (
    <nav className='space-y-4 rounded-3xl border border-border bg-card p-6 text-card-foreground'>
      <p className='text-center leading-6 text-muted-foreground'>{t('whatsNext')}</p>
      <ul>
